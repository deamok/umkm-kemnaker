            ...
            <div class="grid grid-2" style="gap: 3rem; align-items: start;">
                ...
                <div class="product-detail-info flex flex-col justify-start">
                    ...
                    <div class="flex items-center gap-3 mb-8">
                        <div class="flex items-center justify-center border border-gray-300 rounded-md overflow-hidden bg-gray-100 h-10 w-12 relative cursor-ns-resize select-none" id="qty-scroll-area" title="Gulir atau geser atas/bawah untuk mengubah">
